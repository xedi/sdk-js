# Contributing to the XEDI SDK for JavaScript
...
To run the tests locally, ensure you have installed all development dependencies.
...
You can also check for linting issues:

```
npm run linting
```

[issues]: https://github.com/xedi/sdk-js/issues
[pr]: https://github.com/xedi/sdk-js/pulls
[license]: https://github.com/xedi/sdk-js/blob/master/LICENSE
