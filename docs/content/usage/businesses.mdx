...
```
<Flex alignItems="center">
    <H3>Remove User From Business</H3>
    <Box mx="auto" />
</Flex>
...
| Property | Type | Required | Example |
| :-- | :-- | :-: | :-- |
| business_uuid | UUID | <CheckIcon color="green.5"/> | f3ce14b8-b542-11ea-aded-01002da17977 |
| user_id       | UUID | <CheckIcon color="green.5"/> | c52abc50-b499-11ea-a48c-0100f1a50c6e |
