...
<Flash>
<InfoIcon mr={1} />When defining a new section there are a couple of caveats to be aware of, and these are covered in the <Link href="/documentation/structure#sidebar-navigation">section about the Sidebar</Link>.
</Flash>
