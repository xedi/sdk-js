...
<Link href="https://github.com/xedi/sdk-js/blob/master/src/Utils/AuthenticateHeaderParser.ts"><CodeIcon mr={1} />View source<LinkExternalIcon ml={1} /></Link>
...
<Link href="https://github.com/xedi/sdk-js/blob/master/src/Utils/Xuid.ts"><CodeIcon mr={1} />View source<LinkExternalIcon ml={1} /></Link>
